<template>
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <!-- clearable 可以清除 -->
      <el-input v-model="listQuery.studentNo" placeholder="学号" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-select v-model="listQuery.studentSex" placeholder="性别" clearable style="width: 90px" class="filter-item" @change="handleFilter">
        <el-option label="男" value="男" />
        <el-option label="女" value="女" />
      </el-select>
      <el-select v-model="listQuery.classId" class="filter-item" clearable placeholder="班级" @change="handleFilter">
        <el-option v-for="item in clazsInfo" :key="item.id" :label="item.className" :value="item.id" />
      </el-select>
